            ...
            <View style={styles.rect3}>
              <View style={styles.othalm402RowColumnRow}>
                <View style={styles.othalm402RowColumn}>
                  ...
                  <Text style={styles.lastVisit202011}>
                    Last Visit 2020-11-17
                  </Text>
                </View>
                <TouchableOpacity>
                  <Image
          ...
          <View style={styles.rect9}>
            ...
            <View style={styles.row}>
              <View style={styles.col1}>
                <TouchableOpacity
                  ...
                  <Image
                    source={require('../assets/image/Group-9.png')}
                    resizeMode="contain"
                    style={styles.colIcon}></Image>
                </TouchableOpacity>
                <Text style={styles.colText}>Photo</Text>
              </View>
              <View style={styles.col2}>
                ...
                <Text style={styles.colText}>Before / After</Text>
              </View>
            ...
            <View style={styles.row2}>
              <View style={styles.col1}>
                ...
                <Text style={styles.colText}>Note</Text>
              </View>
              <View style={styles.col2}>
                <TouchableOpacity>
                  <Image
            ...
            <View style={styles.row3}>
              <View style={styles.col1}>
                <TouchableOpacity>
                  <Image
                    source={require('../assets/image/health-report.png')}
                    resizeMode="contain"
                    style={styles.colIcon}></Image>
                </TouchableOpacity>
                <Text style={styles.colText}>Form</Text>
              </View>
              <View style={styles.col2}>
                <TouchableOpacity>
                  <Image
                ...
                <Text style={styles.colText}>Store Check</Text>
              </View>
              <View style={styles.col3}>
                <TouchableOpacity>
                  <Image
            ...
            <View style={styles.row4}>
              <View style={styles.finalEnd}>
                <TouchableOpacity>
                  <Image
                    source={require('../assets/image/social-media.png')}
                    resizeMode="contain"
                    style={styles.colIconx}></Image>
                </TouchableOpacity>
                <Text style={styles.colTextx}>Media</Text>
              </View>
            </View>
          </View>
          {/* // So here is modal */}
